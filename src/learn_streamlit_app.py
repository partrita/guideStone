...
st.header("Day30")
st.subheader('YouTube Thumbnail Image Extractor App')
...
st.header("Day29")
st.subheader("How to make a zero-shot learning text classifier using Hugging Face and Streamlit")
st.write("https://www.charlywargnier.com/post/how-to-create-a-zero-shot-learning-text-classifier-using-hugging-face-and-streamlit")
...
with col1:
  st.metric(
       label='Number of Participants', value=suggested_activity['participants'], delta='')
with col2:
  st.metric(
       label='Type of Activity', value=suggested_activity['type'].capitalize(), delta='')
with col3:
  st.metric(
       label='Price', value=suggested_activity['price'], delta='')
...
st.subheader('2. Contents of st.experimental_get_query_params')
st.write(st.experimental_get_query_params())


# 3. Retrieving and displaying information from the URL
# st.subheader('3. Retrieving and displaying information from the URL')
...
with st.form('my_form'):
    ...
    brewing_val = st.selectbox('Brewing method',
...
st.header('Day20')
st.write("Join the Tech Twitter Space on What is Streamlit? (Hosted by Francesco Ciulla) available at https://twitter.com/i/spaces/1dRJZlbglXMKB")
...
st.header('Day18')
st.write("By default, uploaded files are limited to 200MB. You can configure this using the server.maxUploadSize config option. For more info on how to set config options.")
...
st.write("Streamlit Components Components are third-party Python modules")
...
st.header('Day10')
st.subheader("st.selectbox allows the display of a select widget.")
option = st.selectbox(
